  ...
  return (
    <div className="toolbar">
      ...
      <div className="tb-group">
        ...
        <div className="tb-divider" />
        {setShowBuildingsList && (
          <button className={`tb-btn${showBuildingsList ? " active" : ""}`} data-tip="Buildings list"
            ...
            {buildingsCount != null && buildingsCount > 0 && (
              <span style={{ position: "absolute", top: 2, right: 2, background: "#3b82f6", color: "#fff", fontSize: 8, fontWeight: 800, borderRadius: 99, minWidth: 14, height: 14, display: "flex", alignItems: "center", justifyContent: "center", padding: "0 3px", lineHeight: 1 }}>{buildingsCount}</span>
            )}
          </button>
        )}
