    ...
    return (
      <div className="relative w-full group">
        ...
        <input
          type={type}
          className={cn(
            "flex h-11 w-full rounded-xl border border-gray-300/45 dark:border-white/20 bg-background/40 dark:bg-transparent backdrop-blur-md px-4 py-2 text-sm transition-all duration-300 placeholder:text-muted-foreground/40",
