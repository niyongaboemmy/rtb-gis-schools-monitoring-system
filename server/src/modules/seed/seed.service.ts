...
export class SeedService implements OnModuleInit {
  ...
  private async seedAccessLevels() {
    ...
    for (const name of LEVELS) {
      ...
      if (!level) {
        level = await this.accessLevelRepo.save(this.accessLevelRepo.create({ name }));
    ...
    for (const [roleName, levelName] of Object.entries(roleDefaults)) {
      ...
      if (role && !role.accessLevel) {
        ...
        this.logger.log(`✅ Assigned access level "${levelName}" to role: ${roleName}`);
      }
    }
  }
  ...
  private async seedFacilities() {
        ...
        items: [
          {
            ...
            tags: ['Structure'],
            issueCategories: ['Broken chairs', 'Damaged flooring', 'Poor lighting', 'Peeling paint', 'Broken door'],
          },
          {
            id: 'admin_offices',
            label: 'Private offices available',
            tags: ['Structure'],
            issueCategories: ['AC malfunction', 'Broken desks/chairs', 'Door lock failure', 'Window crack', 'Wall damage'],
          },
          {
            id: 'admin_washroom',
            label: 'Accessible washrooms',
            tags: ['Sanitation', 'Accessibility'],
            issueCategories: ['Toilet clog', 'Leaking tap', 'Broken flush', 'No mirror', 'Hygiene issue'],
          },
          {
            id: 'admin_lighting',
            label: 'LED lighting',
            tags: ['Environment'],
            issueCategories: ['Flickering lights', 'Dead bulbs', 'Broken switch', 'Exposed wiring'],
          },
          {
            id: 'admin_ict',
            label: 'Adaptive ICT facilities',
            tags: ['Accessibility'],
            issueCategories: ['Internet down', 'PC hardware failure', 'Printer jam', 'Cable damage'],
          },
          {
            id: 'admin_waste',
            label: 'Waste collection for recycling',
            tags: ['Environment'],
            issueCategories: ['Bin overflow', 'Smell issue', 'Missing bins', 'Broken bin lid'],
          },
          { 
            id: 'admin_fire', 
            label: 'Fire protection', 
            tags: ['Safety'],
            issueCategories: ['Expired extinguisher', 'Damaged detector', 'Missing signage', 'Access blocked'],
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            tags: ['Structure'],
            issueCategories: ['Wall cracks', 'Roof leak', 'Floor holes', 'Peeling paint', 'Damp walls'],
          },
          {
            id: 'class_doors',
            label: '≥2 outward-opening doors, 5m apart',
            tags: ['Safety', 'Structure'],
            issueCategories: ['Broken hinge', 'Missing lock', 'Door stuck', 'Damaged panel', 'Handle loose'],
          },
          {
            id: 'class_windows',
            label: 'Windows for natural light (≥25%)',
            tags: ['Environment', 'Structure'],
            issueCategories: ['Broken glass', 'Stuck frame', 'No latch', 'Water leakage', 'Rattling'],
          },
          {
            id: 'class_ventilation',
            label: 'Natural ventilation / airflow',
            tags: ['Environment'],
            issueCategories: ['Blocked vents', 'Stale air', 'Fan failure', 'Louver damage'],
          },
          { 
            id: 'class_sound', 
          ...
          },
          {
            ...
            tags: ['Safety'],
            issueCategories: ['Expired/Empty', 'Missing', 'Blocked access', 'No pressure'],
          },
          {
            id: 'class_lighting',
            label: 'LED or natural lighting system',
            tags: ['Environment'],
            issueCategories: ['Flickering lights', 'Dead bulbs', 'Exposed wiring', 'Broken switch'],
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            tags: ['Accessibility'],
            issueCategories: ['PC hardware failure', 'Network downtime', 'Damaged cables', 'Projector malfunction'],
          },
          {
            id: 'smart_lighting',
            label: 'LED lighting',
          ...
          },
          {
            ...
            tags: ['Accessibility'],
            issueCategories: ['Adjustable desk stuck', 'Wobbly chair', 'Broken armrest'],
          },
          {
            id: 'smart_doors',
            label: '≥2 outward-opening doors, 5m apart',
            tags: ['Safety', 'Structure'],
            issueCategories: ['Self-closer broken', 'Lock malfunction', 'Door scratches'],
          },
          {
            id: 'smart_ewaste',
          ...
          { 
            ...
            label: 'Fire safety', 
            tags: ['Safety'],
            issueCategories: ['Expired extinguisher', 'Smoke alarm chirping', 'No sign'],
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            tags: ['Structure'],
            issueCategories: ['Wall cracks', 'Roof leak', 'Floor damage', 'Door lock failure'],
          },
          {
            id: 'lab_bench',
            label: 'Chemical/heat-resistant workbenches',
            tags: ['Structure', 'Safety'],
            issueCategories: ['Cracked surface', 'Loose legs', 'Stains/Corrosion', 'Unstable'],
          },
          {
            id: 'lab_utilities',
            label: 'Water, gas & electricity with shut-offs',
            tags: ['Safety', 'Sanitation'],
            issueCategories: ['Gas leak', 'No water pressure', 'Electrical spark', 'Faulty shut-off valve', 'Drainage blockage', 'Power surge'],
          },
          {
            id: 'lab_doors',
            label: '≥2 outward-opening doors, 5m apart',
            tags: ['Safety', 'Structure'],
            issueCategories: ['Stuck door', 'Broken hinge', 'Broken glass', 'Self-closer failing'],
          },
          {
            id: 'lab_ventilation',
            label: 'Fume management / ventilation',
            tags: ['Environment', 'Safety'],
            issueCategories: ['Fume hood failure', 'Strong smells', 'Fan noise', 'Broken louvers'],
          },
          {
            id: 'lab_waste',
            label: 'Hazardous waste disposal storage',
            tags: ['Safety', 'Sanitation'],
            issueCategories: ['Biohazard spill', 'Bin overflow', 'Lack of labels', 'Broken container'],
          },
          {
            id: 'lab_fire',
            label: 'Fire extinguisher & detection system',
            tags: ['Safety'],
            issueCategories: ['Expired', 'Detector chirping', 'Missing signage', 'Broken alarm'],
          },
          { 
            id: 'lab_cctv', 
            label: 'CCTV security coverage', 
            tags: ['Safety'],
            issueCategories: ['Camera offline', 'Poor image', 'Cable loose', 'NVR/DVR issue'],
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            tags: ['Structure'],
            issueCategories: ['Surface stains', 'Touch failure', 'Loose mount', 'Calibration error'],
          },
          { 
            id: 'lang_ict', 
            label: 'ICT facilities', 
            tags: ['Accessibility'],
            issueCategories: ['Headset broken', 'Software error', 'MIC issue', 'Network down'],
          },
          {
            id: 'lang_workspace',
        ...
        items: [
          {
            ...
            tags: ['Accessibility'],
            issueCategories: ['Equipment failure', 'Tech glitch', 'Batteries dead'],
          },
          {
            id: 'sn_furniture',
        ...
        items: [
          {
            ...
            tags: ['Accessibility'],
            issueCategories: ['Furniture damage', 'Carpet stain', 'Space cramped'],
          },
          { 
            id: 'lib_shelves', 
            label: 'Bookshelves', 
        ...
        items: [
          {
            ...
            tags: ['Sanitation'],
            issueCategories: ['Dirty surfaces', 'Pest sighting', 'Broken tiling', 'Clogged sink'],
          },
          {
            id: 'kitchen_cooking',
            label: 'Eco-cooking systems',
            tags: ['Environment'],
            issueCategories: ['Stove failure', 'Smoke buildup', 'Gas smell', 'Fuel shortage'],
          },
          {
            id: 'kitchen_fridge',
            label: 'Efficient refrigeration',
            tags: ['Structure'],
            issueCategories: ['Not cooling', 'Water leak', 'Door seal broken', 'Noisy motor'],
          },
          {
            id: 'kitchen_water',
            label: 'Clean water storage',
            tags: ['Sanitation'],
            issueCategories: ['Tank leak', 'Contaminated water', 'Pump failure', 'Low level'],
          },
          {
            id: 'kitchen_handwash',
            label: 'Handwashing facilities',
            tags: ['Sanitation'],
            issueCategories: ['No soap', 'Broken tap', 'Dry tank', 'Drainage blockage'],
          },
          {
            id: 'kitchen_waste',
            label: 'Liquid/solid waste treatment',
            tags: ['Environment'],
            issueCategories: ['Bin overflow', 'Drainage smell', 'Fly infestation', 'Greywater leak'],
          },
          { 
            id: 'kitchen_fire', 
            label: 'Fire safety', 
            tags: ['Safety'],
            issueCategories: ['Blanket missing', 'Expired extinguisher', 'Gas detector failing', 'Alarm mute'],
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            tags: ['Structure'],
            issueCategories: ['Broken table', 'Broken bench/chair', 'Loose fixings'],
          },
          { 
            id: 'dining_water', 
            label: 'Drinking water', 
            tags: ['Sanitation'],
            issueCategories: ['Dry dispenser', 'Leaking tap', 'Water taste issue'],
          },
          {
            id: 'dining_handwash',
      ...
      },
      {
        ...
        items: [
          { 
            ...
            label: 'Stage area', 
            tags: ['Structure'],
            issueCategories: ['Floor damage', 'Curtain torn', 'Lighting failure'],
          },
          {
            id: 'multi_furniture',
            label: 'Ergonomic furniture',
        ...
        items: [
          {
            ...
            tags: ['Accessibility'],
            issueCategories: ['Broken equipment', 'Sharp edges', 'Rusting', 'Loose bolts'],
          },
          { 
            id: 'sport_safety', 
            label: 'Safe surfaces', 
            tags: ['Safety'],
            issueCategories: ['Cracked court', 'Uneven ground', 'Slippery surface', 'Puddles'],
          },
          {
            id: 'sport_drr',
            label: 'Disaster risk prevention',
            tags: ['Safety'],
            issueCategories: ['Retaining wall crack', 'Soil erosion', 'Poor drainage'],
          },
          {
            id: 'sport_exercise',
            label: 'Exercise areas',
            tags: ['Accessibility'],
            issueCategories: ['Damaged bars', 'Missing components', 'Vandalism'],
          },
          {
            id: 'sport_lighting',
            label: 'Lighting system',
            tags: ['Environment'],
            issueCategories: ['Floodlight out', 'Cable exposure', 'Timer failure'],
          },
        ],
      },
      {
        ...
        items: [
          { 
            ...
            label: 'Safe bedding', 
            tags: ['Safety'],
            issueCategories: ['Torn mattress', 'Broken bed frame', 'Bedbugs/Pests'],
          },
          {
            id: 'sleep_lighting',
            label: 'LED lighting',
      ...
      },
      {
        ...
        items: [
          ...
          { 
            ...
            label: 'Laundry area', 
            tags: ['Sanitation'],
            issueCategories: ['Drainage block', 'Trough crack', 'Water shortage'],
          },
          { 
            id: 'dorm_fire', 
            label: 'Fire safety', 
        ...
        items: [
          {
            ...
            tags: ['Sanitation'],
            issueCategories: ['Clogged toilet', 'Broken flush', 'Broken door/lock', 'No water', 'Smell issue'],
          },
          { 
            id: 'wc_urinals', 
            label: 'Boys urinals', 
            tags: ['Sanitation'],
            issueCategories: ['Stuck valve', 'Unpleasant odor', 'Crack in unit', 'Drainage blockage'],
          },
          {
            id: 'wc_handwash',
            label: 'Handwashing system',
            tags: ['Sanitation'],
            issueCategories: ['No soap', 'Broken tap', 'Leaking pipe', 'Dry tank'],
          },
          {
            id: 'wc_waste',
            label: 'Liquid waste treatment',
            tags: ['Environment'],
            issueCategories: ['Septic tank full', 'Pipe burst', 'Overflow', 'Foul smell'],
          },
          { 
            id: 'wc_lighting', 
            label: 'LED lighting', 
            tags: ['Environment'],
            issueCategories: ['Dark area', 'Dead bulb', 'Flickering', 'Exposed wires'],
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            tags: ['Environment'],
            issueCategories: ['Rusted wire', 'Broken post', 'Hole in fence', 'Leaning wall'],
          },
          {
            id: 'fence_access',
            label: 'Accessible entrance',
            tags: ['Accessibility'],
            issueCategories: ['Gate stuck', 'Broken ramp', 'Broken handle', 'Key lost'],
          },
          {
            id: 'fence_security',
            label: 'Passive surveillance',
            tags: ['Safety'],
            issueCategories: ['CCTV offline', 'Blind spot', 'Broken light', 'Overgrown bushes'],
          },
          { 
            id: 'fence_guard', 
            label: 'Guardhouse', 
            tags: ['Safety'],
            issueCategories: ['Broken window', 'Furniture damage', 'No radio', 'Roof leak'],
          },
          {
            id: 'fence_standard',
    ...
    this.logger.log(`✅ Seeded/Updated ${facilities.length} facility categories`);
  }
}
